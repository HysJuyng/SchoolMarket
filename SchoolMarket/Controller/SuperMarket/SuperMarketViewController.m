...
//@property (nonatomic, strong) UITableView *category;
...
@property (nonatomic, strong) SuperMarketView *smView;
...
//    [self GoodsCollectionView];
    ...
    self.smView = [[SuperMarketView alloc] initWithFrame:CGRectMake(0, smViewY, smViewW, smViewH)];
